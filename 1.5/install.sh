...
# Client side:
# curl -L http://192.168.0.104:8000/install.sh |  bash -s join --token=6669b1.81f129bc847154f9 192.168.0.104
...
kube::master_up()
{
    ...
    #install dashboard
    kubectl apply -f http://$HTTP_SERVER/network/kubernetes-dashboard.yaml
